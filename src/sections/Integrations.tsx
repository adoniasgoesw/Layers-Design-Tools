...
import IntegrationsCollum from "@/components/IntegrationsCollum";
...
export default function Integrations() {
    return <section className="py-24 overflow-hidden">
        <div className="container">
            ...
            <p className="text-white/50 mt-4 lext-lg">
                Layers seamlessly connects with your favorite tool, making it easy plug into my workflow and collaborate across platforms.
            </p>
            </div>
            ...
            >
                ...
                <IntegrationsCollum Integrations={integrations} />
                <IntegrationsCollum Integrations={integrations.slice().reverse()}
                reverse 
