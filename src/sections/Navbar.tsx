                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 border border-white/15 rounded-full p-2 px-4 md:pr-2 items-center ">
                            ...
                            <div className="flex justify-end gap-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-menu md:hidden cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
                                    <line x1="3" y1="12" x2="21" y2="12" className={twMerge("origin-center transition-transform duration-300", isOpen && "rotate-45 translate-y-1")}></line>
                                    <line x1="3" y1="6" x2="21" y2="6" className={twMerge("transition-opacity duration-300", isOpen && "opacity-0")}></line>
                                    <line x1="3" y1="18" x2="21" y2="18" className={twMerge("origin-left transition-transform duration-300", isOpen && "-rotate-45 translate-y-2")}></line>
                                </svg>
                            ...
                            {isOpen && (
                                ...
                                <motion.div
                                    ...
                                    <div className="flex flex-col items-center gap-4 py-4">
                                        ...
                                        <Button variant="secondary" className="w-auto">Log In</Button>
                                        <Button variant="primary" className="w-auto">Sign Up</Button>
                                    </div>
                                </motion.div>
